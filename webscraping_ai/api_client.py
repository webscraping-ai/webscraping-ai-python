...
from webscraping_ai.api_response import ApiResponse, T as ApiResponseT
import webscraping_ai.models
from webscraping_ai import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(webscraping_ai.models, klass)
