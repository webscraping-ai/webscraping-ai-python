...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of webscraping_ai.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = webscraping_ai.Configuration(
    ...
    Note you can use the constants defined in the webscraping_ai.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = webscraping_ai.Configuration(
        signing_info = webscraping_ai.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://webscraping.ai/api",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("webscraping_ai")
