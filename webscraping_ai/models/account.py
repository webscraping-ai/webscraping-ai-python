...
class Account(BaseModel):
    ...
    Account
    """ # noqa: E501
    email: Optional[StrictStr] = Field(default=None, description="Your account email")
    ...
    __properties: ClassVar[List[str]] = ["email", "remaining_api_calls", "resets_at", "remaining_concurrency"]
